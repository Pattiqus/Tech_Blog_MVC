...
var UserController = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        req.session.save(function () {
                            req.session.user_id = userData_1.id;
                            req.session.logged_in = true;
                            res.status(200).json(userData_1);
                        });
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _a.sent();
    ...
    UserController.prototype.loginUser = function () {
        ...
        this.router.post("/login", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var userData_2, validPassword, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, userData_2.checkPassword(req.body.password)];
                    case 2:
                        ...
                        req.session.save(function () {
                            req.session.user_id = userData_2.id;
                            req.session.logged_in = true;
                            res.json({ user: userData_2, message: "You are now logged in!" });
                        });
                        return [3 /*break*/, 4];
                    case 3:
                        err_2 = _a.sent();
